...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields = array(
		'author' => sprintf(
			...
			sprintf(
				'<input id="author" placeholder="Prénom" name="author" type="text" value="%s" size="30" maxlength="245"%s />',
	...
	$defaults = array(
		...
		'comment_field'        => sprintf(
			...
			'<textarea id="comment" name="comment" placeholder="Commentaire" cols="45" rows="8" maxlength="65525" required="required"></textarea>'
		),
		'must_log_in'          => sprintf(
