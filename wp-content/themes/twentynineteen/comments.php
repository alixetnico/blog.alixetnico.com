	...
	<div class="<?php echo $discussion->responses > 0 ? 'comments-title-wrap' : 'comments-title-wrap no-responses'; ?>">
		...
		if ( comments_open() ) {
			...
			if ( '1' == $discussion->responses ) {
				...
				printf( _x( 'Commentaire', 'comments title', 'twentynineteen' ), get_the_title() );
			} else {
				printf(
	...
	if ( have_comments() ) :
		...
		if ( comments_open() && 'asc' === strtolower( get_option( 'comment_order', 'asc' ) ) ) :
			...
			<div class="comment-form-flex">
				<span class="screen-reader-text"><?php _e( 'xLeave a comment', 'twentynineteen' ); ?></span>
		...
		if ( ! comments_open() ) :
			...
			<footer class="entry-footer">
				<span class="comclose">Les commentaires sont fermés.</span></footer>
			<?php
		endif;
