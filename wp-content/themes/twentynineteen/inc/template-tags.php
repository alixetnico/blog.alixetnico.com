...
if ( ! function_exists( 'twentynineteen_posted_on' ) ) :
	...
	function twentynineteen_posted_on() {
		...
		printf(
			'<span class="posted-on"><a href="%2$s" rel="bookmark">Publié le %3$s.</a></span>',
...
if ( ! function_exists( 'twentynineteen_comment_count' ) ) :
	...
	function twentynineteen_comment_count() {
		if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
			...
			comments_popup_link( sprintf( __( 'XLeave a comment<span class="screen-reader-text"> on %s</span>', 'twentynineteen' ), get_the_title() ) );
